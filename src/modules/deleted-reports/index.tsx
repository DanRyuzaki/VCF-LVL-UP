          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Report ID</span><span>: {selectedReport.reportId}</span></div>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Date Generated</span><span>: {selectedReport.dateGenerated}</span></div>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Time Generated</span><span>: {selectedReport.timeGenerated}</span></div>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Generated By</span><span>: {selectedReport.generatedBy}</span></div>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px", borderLeft: "1px solid rgba(255, 255, 255, 0.08)", paddingLeft: "24px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Date Deleted</span><span>: {selectedReport.dateDeleted}</span></div>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Time Deleted</span><span>: {selectedReport.timeDeleted}</span></div>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Deleted By</span><span>: {selectedReport.deletedBy}</span></div>
                  <div style={{ display: "flex" }}><span style={{ width: "130px", color: "#94A3B8" }}>Deletion Category</span><span>: {selectedReport.deletionCategory}</span></div>
                </div>
              </div>
