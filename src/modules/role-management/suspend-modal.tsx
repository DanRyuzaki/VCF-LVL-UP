      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <textarea
          ...
          style={{
            ...
            border: `1px solid ${submitted && !reason.trim() ? "#EF4444" : "var(--c-border)"}`,
            borderRadius: "8px",
            padding: "10px 12px",
            fontSize: "13px",
            color: "var(--c-text)",
          ...
          onFocus={(e) => {
            if (reason.trim() || !submitted) e.currentTarget.style.borderColor = "var(--c-accent)";
          }}
          onBlur={(e) => {
            e.currentTarget.style.borderColor = submitted && !reason.trim() ? "#EF4444" : "var(--c-border)";
          }}
        />
